...
from tensorforce.contrib.vizdoom import ViZDoom

# python examples/ViZDoom.py -a examples/configs/ppo.json -v examples/configs/vizdoom/basic.cfg -n examples/configs/mlp2_network.json
