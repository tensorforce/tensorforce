...
setup(name='tensorforce',
      version='0.4.0',  # please remember to edit tensorforce/__init__.py when updating the version
      description='Reinforcement learning for TensorFlow',
      url='http://github.com/reinforceio/tensorforce',
      download_url='https://github.com/reinforceio/tensorforce/archive/0.4.0.tar.gz',
      author='reinforce.io',
