...
agents = dict(
    acktr=ACKTRAgent, constant=ConstantAgent, ddpg=DDPGAgent, dqfd=DQFDAgent, dqn=DQNAgent,
    dqn_nstep=DQNNstepAgent, naf=NAFAgent, ppo=PPOAgent, random=RandomAgent, trpo=TRPOAgent,
    vpg=VPGAgent
)


__all__ = [
    'ACKTRAgent', 'Agent', 'agents', 'ConstantAgent', 'DDPGAgent', 'DQFDAgent', 'DQNAgent',
    'DQNNstepAgent', 'DRLAgent', 'NAFAgent', 'PPOAgent', 'RandomAgent', 'TRPOAgent', 'VPGAgent'
]
