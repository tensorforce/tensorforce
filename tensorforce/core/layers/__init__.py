...
from tensorforce.core.layers.internal_rnns import InternalLstm
from tensorforce.core.layers.misc import Activation, Dropout
from tensorforce.core.layers.poolings import Pooling
from tensorforce.core.layers.rnns import Lstm


layer_modules = dict(
    activation=Activation, conv1d=Conv1d, conv2d=Conv2d, dense=Dense, dropout=Dropout,
    embedding=Embedding, internal_lstm=InternalLstm, linear=Linear, lstm=Lstm, pooling=Pooling,
    register=Register, retrieve=Retrieve
)


__all__ = [
    'Activation', 'Conv1d', 'Conv2d', 'Dense', 'Dropout', 'Embedding', 'InternalLstm', 'Layer',
    'layer_modules', 'Linear', 'Lstm', 'Nonlinearity', 'Pooling', 'Register', 'Retrieve',
    'TransformationBase'
]
