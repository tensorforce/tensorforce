...
class TestMemoryAgent(unittest.TestCase):
    ...
    def test_memoryagent_update_frequency(self):
        """
        ...
        self.assertEqual(agent.update_steps, update_steps)
        self.assertEqual(agent.target_update_steps, target_update_steps)
        self.assertEqual(agent.min_replay_size, config['min_replay_size'])
        self.assertEqual(agent.use_target_network, config['use_target_network'])
        ...
        self.assertEqual(model.count_updates, expected_updates)
        self.assertEqual(model.count_target_updates, expected_target_updates)
        self.assertEqual(memory_capacity, agent.memory.size)
